...
- **Slam the spacebar** (or ⏎, ⌘C, ⌃C) and the annotated shot is on your clipboard. The whole thing is fn+⌃, drag, space. **Save…** (or ⌘S) writes a PNG instead. **Esc** bails out.
