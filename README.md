...
Press ⌥⌘→, drag over what you want, draw a red arrow at the thing, hit ⏎. It's in your clipboard. Instant even on multi-monitor setups, because the screen is frozen locally the moment you press the key. No account, no cloud, free forever.
...
**2. Allow Screen Recording** when macOS asks. If you missed the prompt, go to System Settings > Privacy & Security > Screen & System Audio Recording and turn QuickShot on, then relaunch it.

**3. Press ⌥⌘→ and drag.** Done.

## Use

- **⌥⌘→** freezes all your screens under a dimmed overlay. Drag to select.
